                    ...
                    <div class="box-body">
                        <form id="form-insert-item" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jml_produk" class="form-control" placeholder="Masukkan jumlah produk ..." required/>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        // Menampilkan list item saat halaman utama diload
        ...
        // Proses pencarian item ketika mengetik kode model
